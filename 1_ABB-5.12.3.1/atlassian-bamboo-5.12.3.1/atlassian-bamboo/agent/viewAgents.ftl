                    ...
                    <table id="local-agents" class="aui">
                        ...
                        <tbody>
                            [#foreach agent in localAgents]
                                [#assign dedicatedNoMatch = dedicatedNonMatchingAgents?seq_contains(agent) /]
                                <tr>
                                    <td>[@ui.renderAgentNameLink agent=agent dedicatedLozenge=true missesRequirements=dedicatedNoMatch /]</td>
            ...
            <table class="aui">
                ...
                <tbody>
                    [#list elasticImageConfigurations as configuration]
                        [#assign dedicatedNoMatch = dedicatedNonMatchingElasticConfiguration?seq_contains(configuration) /]
                        ...
                        <tr>
                            <td>
                                ...
                                [#if dedicatedNoMatch] [@ui.agentDedicatedUnmatchedLozenge subtle=true /][/#if]
                            </td>
