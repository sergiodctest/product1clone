...
[#assign ignoredTestCaseCount = testSummary.ignoredTestCaseCount /]
        ...
        [#if testSummary.totalTestCaseCount > 0 && chainResult.finished]
            <div class="test-summary">
                <ul>
                    ...
                    [#if hasIgnoredTests][#compress ]
                        <li class="ignored">
                            <a href="[@ww.url value='/browse/${chainResult.planResultKey}/test/#ignored-tests' /]">
                                ${ignoredTestCaseCount} <span>[@ww.text name='chain.summary.test.ignored'/]</span>
                            </a>
                        </li>
                    [/#compress][/#if]
                </ul>
...
<script type="text/javascript">
    ...
    AJS.trigger('analyticsEvent', {
        ...
        data: {
            planbranch: ${fn.isBranch(plan)?string("true", "false")}
        }
    });
