...
(function () {
    ...
    window.AJS = (function () {
        ...
        var res = {
            ...
            /**
             * debounceImmediate() makes sure that a constantly firing function doesn't cause
             + performance issues, but fires at the start rather than at the end of the wait period
             */
            debounceImmediate: function (func, wait) {
                var timeout = null;
                var result;
                return function () {
                    var context = this;
...
(function($, Alignment, skate, template, browser) {
    ...
    function restorePreviousAlignment(dropdown) {
        ...
        var hasPreviousAlignment = $dropdown.data('previous-data-aui-alignment') || $dropdown.data('had-data-aui-alignment-static');
        if (!hasPreviousAlignment) {
            return;
        }
...
(function ($, skate, template, debounce) {
    ...
    Header.prototype = {
        init: function () {
            ...
            this.$headerFind('.aui-button').parent('li').each(function () {
        ...
        createResponsiveDropdownTrigger: function () {
            ...
            var dropdownEl = document.createElement('aui-dropdown');
            dropdownEl.id = 'aui-responsive-header-dropdown-' + this.index;
            dropdownEl.setAttribute('label', AJS.I18n.getText('aui.words.more'));
            template.wrap(dropdownEl).innerHTML = '<ul id="aui-responsive-header-dropdown-list-' + this.index + '" role="presentation"></ul>';
        ...
        moveOutOfResponsiveDropdown: function (numItems) {
            ...
            var $moreDropdownTrigger = this.$moreMenu.find('> aui-dropdown > a');
            ...
            for (var i = leftMostIndexToMove; i <= rightMostIndexToMove; i++) {
                ...
                $navItem.removeAttr('role');
                if ($navItemTrigger.attr('aria-controls')) {
                    $navItemTrigger.removeClass('aui-dropdown2-sub-trigger');
        ...
        moveToResponsiveDropdown: function (numItems) {
            ...
            var moreDropdownSectionEl = document.querySelector('#aui-responsive-header-dropdown-list-' + this.index);
            ...
            for (var i = rightMostIndexToMove; i >= leftMostIndexToMove; i--) {
                ...
                if ($navItemTrigger.attr('aria-controls')) {
                    $navItemTrigger.addClass('aui-dropdown2-sub-trigger');
    ...
    skate('aui-header', {
        ...
        attached: function (element) {
            element._instance = createHeader(element);
        },
