...
<p>
    <a href="${req.contextPath}/rss/createAllBuildsRssFeed.action?feedType=rssAll&amp;buildKey=${immutablePlan.key}${rssSuffix}">[@ui.icon useIconFont=true type="rss" text="'${immutablePlan.name}' all builds RSS feed" /]</a>
