...
[#function canEditPlan plan]
    [#return hasPlanPermission("ADMINISTRATION", plan) || hasPlanPermission("WRITE", plan) || hasAdminPermission() ]
[/#function]
...
[#-- ======================================================================================== @fn.isOnDemandInstance --]
[#function isOnDemandInstance ]
    [#if ctx?has_content]
        [#return ctx.onDemandInstance]
    [#else]
        [#return action.featureManager.onDemandInstance]
    [/#if]
[/#function]

[#function displayCreateRepositoryLink]
    [#return action.featureManager.repositoryDashboardEnabled && hasGlobalPermission("CREATEREPOSITORY")/]
[/#function]
