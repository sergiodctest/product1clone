...
[@s.text id="title" name="deployment.project.edit.permissions.title"]
...
<div class="aui-group permissionForm">
    <div class="aui-item formArea">
        [@ww.form action='updateDeploymentProjectPermissions' submitLabelKey='global.buttons.update' id='permissions' cancelUri='/deploy/config/configureDeploymentProject.action?id=${deploymentProjectId}' cssClass='top-label']
            [@permissions.permissionsEditor entityId=deploymentProjectId editablePermissions=editablePermissions /]
    ...
    <div class="aui-item helpTextArea">
        ...
        <ul>
            <li>
                <strong>[@s.text name='build.permissions.type.view.heading' /]</strong> - Controls who can see this project and its associated environments.
            </li>
            <li>
                <strong>[@s.text  name='build.permissions.type.edit.heading' /]</strong> - Controls who can change the details of the project, related plan and any of the environment configuration. Users with edit permission can also create releases.
            </li>
        </ul>
