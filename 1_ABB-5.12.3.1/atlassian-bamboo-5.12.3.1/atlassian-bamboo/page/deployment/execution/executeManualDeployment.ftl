...
<script type="text/javascript">
    require(['jquery', 'feature/deployment-release'], function($, DeploymentRelease){
...
[@ww.form id="executeManualDeployment" action="executeManualDeployment" namespace="/deploy" cancelUri=cancelUrl!"" ]
    ...
    [#if !action.hasActionErrors()]
        <div class="aui-group">
            <div class="aui-item aui-item-select-release">
                ...
                [#if versionId == 0]
                    ...
                    <div class="radio">
                        [#assign canCreateFromBranches = action.hasBranches() && action.canDeployFromCustomBranch() /]
                        <input id="releaseTypeCreateOption"
                            ...
                            [#if !canCreateFromBranches && !action.hasDefaultPlanBuildResults()]disabled=disable[/#if]
                        >
                        <label for="releaseTypeCreateOption">[@ww.text name="deployment.version.create"/]</label>
                        [#if !canCreateFromBranches && !action.hasDefaultPlanBuildResults()]
                        ...
                        [#else]
                            [@ui.bambooSection dependsOn='releaseTypeOption' showOn='CREATE' cssClass='field-group']
                                <div [#if !canCreateFromBranches]class="hidden"[/#if]>
                                    [@s.textfield
                    ...
                    <div class="radio">
                        ...
                        [@ui.bambooSection dependsOn='releaseTypeOption' showOn='PROMOTE' cssClass='field-group']
                            [#if action.hasReleasesFromBranches()]
                                [@s.textfield
        ...
        <div class="aui-item">
            ...
            <script type="text/javascript">
                require(['jquery', 'page/deployment/view-deployment-preview'], function($, deploymentPreview){
                    deploymentPreview.init({
        ...
        [@ww.param name="buttons"]
            [@ww.submit
                ...
                disabled=(!action.hasAtLeastOneVersion() && !action.hasBranches() && !action.hasDefaultPlanBuildResults())
                primary=true
                name='save'
            /]
        [/@ww.param]
