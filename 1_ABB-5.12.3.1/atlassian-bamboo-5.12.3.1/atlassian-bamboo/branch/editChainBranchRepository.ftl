            ...
            <div id="repository-selector">
                ...
                [@ui.bambooSection id='repository-configuration' dependsOn="overrideRepository" showOn="true"]
                    ...
                    [@ui.bambooSection id='repository-configuration']
                        ...
                        [#if repositoryUtils.isRepositoryTestConnectionAware(repositoryDefinition.repository)]
                            [@rc.testRepositoryConnectionButton id="test-connection-" + repositoryDefinition.repository.key?replace('[^a-zA-Z0-9]', '-', 'r') /]
                        [/#if]
