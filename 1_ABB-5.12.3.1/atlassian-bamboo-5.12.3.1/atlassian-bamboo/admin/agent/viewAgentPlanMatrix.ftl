...
<head>
    ...
    <meta name="adminCrumb" content="agentMatrix">
</head>
...
<div class="agent-plan-matrix">
    <table class="aui">[#compress]
        ...
        <tr>
            ...
            [/#list]
            [#if elasticEnabled && images?has_content && permissionManager.canManageElasticBamboo()]
        ...
        <tbody>
            ...
            <tr>
                ...
                <tr>
                    ...
                    [/#list]
                    [#if elasticEnabled && permissionManager.canManageElasticBamboo()]
