...
[#macro quickFilterRulesMainPanel rules]
    [@s.url id="addUrl" action="addQuickFilterRule" namespace="/admin" returnUrl=currentUrl quickFilterId=quickFilter.id/]
    [@s.url id="editUrl" action="editQuickFilterRule" namespace="/admin" returnUrl=currentUrl quickFilterId=quickFilter.id/]
    [@s.url id="confirmDeleteUrl" action="confirmDeleteQuickFilterRule" namespace="/admin" returnUrl=currentUrl quickFilterId=quickFilter.id/]
