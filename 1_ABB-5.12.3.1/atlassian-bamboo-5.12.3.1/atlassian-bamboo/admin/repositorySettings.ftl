...
<head>
    ...
    <meta name="adminCrumb" content="repositorySettings">
</head>
...
<p>[@ww.text name='manageCaches.description' /]</p>
    ...
    <p>[@ww.text name=cacheProvider.handlerDescription /]</p>
        [@ww.form action="repositorySettingsDelete.action" id=provider theme="simple" namespace="/admin"]
        ...
        <table id="summary" class="aui">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a id="delete:${cacheDescription.location}" data-delete-cache-key="${cacheDescription.key}" class="mutative delete" href="[@ww.url action='repositorySettingsDelete' namespace='/admin' providerId=provider singleCacheSelected=true selectedCaches=cacheDescription.key /]">[@ww.text name='global.buttons.delete' /]</a>
                    </td>
                </tr>
                [/#list]
            </tbody>
...
<p>[@ww.text name='automaticCommits.description' /]</p>
    [@ww.form action="updateRepositorySettingsAutomaticCommits.action" id="automaticCommitsSettings" submitLabelKey="global.buttons.submit" namespace="/admin"]
...
<p>[@ww.text name='subversion.working.copies.description' /]</p>
    [@ww.form action="repositorySettingsUpdateSubversionPreferences.action" id="subversionWorkingCopySettings" submitLabelKey="global.buttons.update" namespace="/admin"]
