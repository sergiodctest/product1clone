                                ...
                                <tr>
                                    ...
                                    <td>
                                        [#if volume.state == "available"]
                                            <a class="mutative" href="[@ww.url action='deleteEbsVolume' namespace='admin/elastic' volumeId=volume.volumeId returnUrl=currentUrl /]">[@ww.text name='elastic.manage.delete.volume' /]</a>
                                        [/#if]
                                    </td>
                                </tr>
                            [/#list]
