                        ...
                        <div id="system-help-menu-content" class="aui-dropdown2 aui-style-default">
                            <div class="aui-dropdown2-section">
                                <ul class="aui-list-truncate">
                                    <li><a target="_blank" href="https://confluence.atlassian.com/display/BAMBOO/Running+the+Setup+Wizard">Setup Help</a></li>
                                    <li><a target="_blank" href="https://confluence.atlassian.com/display/BAMBOO">Bamboo Help</a></li>
                                    <li><a target="_blank" href="https://answers.atlassian.com/tags/bamboo/">Bamboo Answers</a></li>
                                </ul>
                            </div>
                        </div>
                    </li>
