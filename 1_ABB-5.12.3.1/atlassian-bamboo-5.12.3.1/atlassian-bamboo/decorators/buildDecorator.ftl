    ...
    [#assign headerActionsButtons]
        [#if project?? && !immutablePlan??]
            ${soy.render("bamboo.layout.projectActions", {
                ...
                "hasEditPermission" : ctx.hasProjectEditPermission(project)
            })}
            <script type="text/javascript">
                function updateProjectName(response) {
            ...
            [@dj.simpleDialogForm
                triggerSelector=".edit-project-name" submitCallback="updateProjectName"
                width=540 height=230 headerKey="project.edit.title"
            /]
        [/#if]
    [/#assign]
