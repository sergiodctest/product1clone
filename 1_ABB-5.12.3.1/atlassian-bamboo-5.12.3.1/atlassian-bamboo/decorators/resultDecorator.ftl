...
[#macro displayFavicon decoratedResult navObject]
    ...
    [#if decoratedResult.status.buildState == "Successful"]
        [#if decoratedResult.status.continuable]
            [#assign favicoUrl = "/images/iconsv4/icon-build-continue.png"/]
            [#assign favicoType = "image/png"/]
        [#else]
            [#assign favicoUrl = "/images/iconsv4/icon-build-successful.png"/]
            [#assign favicoType = "image/png"/]
        [/#if]
    [#elseif decoratedResult.status.buildState == "Failed"]
        [#assign favicoUrl = "/images/iconsv4/icon-build-failed.png"/]
        [#assign favicoType = "image/png"/]
    [#else]
        [#if decoratedResult.status.lifeCycleState == "Queued" || decoratedResult.status.lifeCycleState == "Pending"]
            [#assign favicoUrl = "/images/iconsv4/icon-build-queued.png"/]
            [#assign favicoType = "image/png"/]
        [#elseif decoratedResult.status.lifeCycleState == "InProgress"]
            [#assign favicoUrl = "/images/iconsv4/icon-building-static.png"/]
            [#assign favicoType = "image/png"/]
        [#elseif decoratedResult.status.notRunYet]
            [#assign favicoUrl = "/images/iconsv4/icon-build-job.png"/]
            [#assign favicoType = "image/png"/]
        [#else]
            [#assign favicoUrl = "/images/iconsv4/icon-build-unknown.png"/]
            [#assign favicoType = "image/png"/]
        [/#if]
    [/#if]
    <script type="text/javascript">
