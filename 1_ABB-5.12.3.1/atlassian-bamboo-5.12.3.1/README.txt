---------------------------------------------------------------------
Bamboo 5.12.3.1-#51215 README
---------------------------------------------------------------------

Thank you for downloading Bamboo 5.12.3.1 - Server distribution.  This
distribution comes with a built-in Tomcat 8.0.32-atlassian-hosted web server and hsql
...
3. Set your Bamboo Home directory.
   Instructions how to set your Bamboo Home directory can be found here: https://confluence.atlassian.com/display/BAMBOO/Installing+and+upgrading+Bamboo
